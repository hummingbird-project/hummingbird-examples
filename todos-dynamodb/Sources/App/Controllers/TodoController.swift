...
struct TodoController: Sendable {
    ...
    func list(_ request: Request, context: some RequestContext) async throws -> [Todo] {
    ...
    func create(_ request: Request, context: some RequestContext) async throws -> EditedResponse<Todo> {
    ...
    func get(_ request: Request, context: some RequestContext) async throws -> Todo? {
    ...
    func updateId(_ request: Request, context: some RequestContext) async throws -> Todo {
    ...
    func deleteAll(_ request: Request, context: some RequestContext) async throws -> HTTPResponse.Status {
    ...
    func deleteId(_ request: Request, context: some RequestContext) async throws -> HTTPResponse.Status {
        let id = try context.parameters.require("id")
